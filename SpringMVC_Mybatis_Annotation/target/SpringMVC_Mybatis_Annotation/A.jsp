            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <script type="text/javascript">
                        ...
                        saltElement = [];
                        pointId = [];
                        $.getJSON('http://148.70.138.222:8080/SpringMVC_Mybatis_Annotation/AreaElement/getData?areaName=A', function (data) {
                            console.log(data);
                        ...
                        $(function () {
                            $('#n').countTo({to: nAvg[0]});
                            $('#salt').countTo({to: saltAvg[0]});
                            $('#water').countTo({to: waterAvg[0]});
                        });
