                ...
                <div class="card">
                   ...
                   <div class="body" style="">
                    ...
                    <script type="text/javascript">
                            ...
                            xAxis : [
                                {
                                    ...
                                    data : ['1号点','2号点','3号点','4号点','5号点','6号点','7号点','8号点','9号点','10号点','11号点','12号点']
                                }
                            ],
                            yAxis : [
                                {
                        ...
                        saltElement=[];
                        pointId=[];
                        $.getJSON('http://148.70.138.222:8080/SpringMVC_Mybatis_Annotation/AreaElement/getData?areaName=B',function(data){
                            console.log(data);
                        ...
                        $(function () {
                            $('#n').countTo({to: nAvg[1]});
                            $('#salt').countTo({to:saltAvg[1]});
                            $('#water').countTo({to:waterAvg[1]});
                        });
                    </script>
                </div>
            </div>
