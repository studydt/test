 ...
 <%@ include file="menu.jsp"%><section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>D区土壤元素含量平均数值--点击查看处理策略</h2>
        </div>

         <%@ include file="threeTab.jsp"%>
        <!-- CPU Usage -->
                ...
                <div class="card">
                   ...
                   <div class="body" style="">
                    ...
                    <script type="text/javascript">
                        ...
                        saltElement=[];
                        pointId=[];
                        $.getJSON('http://148.70.138.222:8080/SpringMVC_Mybatis_Annotation/AreaElement/getData?areaName=D',function(data){
                            console.log(data);
                        ...
                        $(function () {
                            $('#n').countTo({to: nAvg[3]});
                            $('#salt').countTo({to:saltAvg[3]});
                            $('#water').countTo({to:waterAvg[3]});
                        });
                    </script>
                </div>
            </div>
